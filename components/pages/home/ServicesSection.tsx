...
const services = [
  ...
  {
    icon: Handshake,
    title: "خدمات التفاوض وتسوية النزاعات",
    short: "تفاوض احترافي • حلول تجارية سريعة",
    description:
      "توفر المؤسسة خدمات متخصصة في التفاوض القانوني بين الأطراف بهدف تسوية النزاعات بطريقة احترافية تحقق مصالح جميع الأطراف. وتساهم هذه الخدمة في حل النزاعات التجارية بسرعة وفعالية دون الدخول في إجراءات قضائية طويلة.",
  },
  {
    icon: Receipt,
