        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="flex flex-col gap-5">
              ...
              {/* Skills */}
              <div className="mt-2">
                <p className="text-(--gold) font-bold text-sm tracking-wider uppercase mb-4">
                  المهارات المهنية
                </p>
          ...
          <div className="flex flex-col gap-4">
            <motion.p
              ...
              className="text-(--gold) font-bold text-sm tracking-wider uppercase mb-2"
            >
              المؤهلات العلمية
            </motion.p>
            {academicQualifications.map((q, i) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="inline-flex items-center gap-1 mt-1 text-xs font-bold text-(--gold-dark) bg-(--gold)/10 px-2 py-0.5 rounded-full w-fit">
